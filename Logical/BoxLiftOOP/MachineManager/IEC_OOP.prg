...
<Program SubType="IEC_OOP" xmlns="http://br-automation.co.at/AS/Program">
  <Files>
    <File Description="Method implementation" TransferedForTargetSourceCompare="true">BoxLiftSTOOP.stpp</File>
    <File Description="Fub implementation" Private="true" TransferedForTargetSourceCompare="true">BoxLiftSTOOP.fub</File>
